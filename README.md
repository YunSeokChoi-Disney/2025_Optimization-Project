...
## Appendix — About Project 1 files

The files `PJ1_Problem1_(4).py`, `PJ1_Problem1_(5).py`, and `PJ1_Problem1_(6).py` belong to
**Project 1** and are **not** part of this Project 3 branch. Refer to the sections above and the
solution PDF for the reinforcement-learning implementation.
